...
<ol>
<li>Click on a position title link to redirect you to the application page (opens a new tab).</li>
<li>Click "Apply" or "Autofill with Greenhouse"</li>
<li>Fill in any additional fields</li>
<li>Lastly, click "Submit application"</li>
<li>Navigate back to WRKPMP and repeat this process</li>
	</ol>
